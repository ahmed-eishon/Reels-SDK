...
package_aar() {
    ...
    if [ "$BUILD_MODE" == "Release" ]; then
        ...
        FLUTTER_SOURCE="reels_flutter/build/host/outputs/repo/com/rakuten/room/flutter_release/1.0/flutter_release-1.0.aar"
        ...
        FLUTTER_SOURCE="reels_flutter/build/host/outputs/repo/com/rakuten/room/flutter_debug/1.0/flutter_debug-1.0.aar"
